...
class HTMLGenerator {
  ...
  generateJobCard(job) {
    ...
    const sourceKey = isAJO ? 'ajo' : 'inspirehep';
  ...
  generateHTML(inspirehepData, ajoData) {
    ...
    const totalJobs = inspirehepJobs.length + ajoJobs.length;
    const activeJobs = inspirehepActiveJobs.length + ajoActiveJobs.length;
